...
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑴𝑴 ┉  ┉ ┉ ┉ ┉≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑴𝑴 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝑬𝑳𝑴𝑴 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ELMMALIK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("messi", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ELMMALIK -X kill
screen -S ELMMALIK ./ELMMALIK
done
]])  
file:close() 
...
sudo_users = {SUDO,1925008261,1102055673,1931283050}   
function SudoBot(msg)  
local ELMMALIK = false  
...
if tonumber(user_id) == tonumber(1925008261) then  
var = true  
elseif tonumber(user_id) == tonumber(1931283050) then
var = true  
elseif tonumber(user_id) == tonumber(1102055673) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ميسي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "Messi_ElKBer")
...
local ELMMALIK_Msg = ''  
if msgs < 100 then 
ELMMALIK_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ELMMALIK_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ELMMALIK_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ELMMALIK_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ELMMALIK_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ELMMALIK_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ELMMALIK_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ELMMALIK_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ELMMALIK_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ELMMALIK_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ELMMALIK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ELMMALIK_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ELMMALIK_Msg = 'رب التفاعل'  
end 
return ELMMALIK_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 MESSI")  
...
function plugin_Elmmalik(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Elmmalik and msg then
pre_msg = plugin.ELMMALIK(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceElmmalik(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ELMMALIK_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf ELMMALIK.lua')
os.execute('wget https://raw.githubusercontent.com/black801/lol/main/ELMMALIK.lua')
send(msg.chat_id_, msg.id_,' ★ تم تحديث السورس \n ★ لديك اخر اصدار لسورس ميسي\n ★ الاصدار » { v 1.5}')
dofile('ELMMALIK.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ★ اصدار سورس ميسي \n ★ الاصدار »{ v 1.5}')
end
if text == 'ميسي مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV desa](t.me/Kory_111)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '', url="t.me/Kory_111"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](https://t.me/messihack1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/https:/messihack1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/lionel_messi_foa1bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑀𝐸𝑆𝑆𝐼', url="t.me/lionel_messi_foa1bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'★  عدد الجروبات الان » { '..#group..' }'..ELMMALIKk..''..ELMMALIK..'\n★  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ★ العضو » ['..result.title_..'](t.me/'..(username or 'Messi_ElKBer')..')'
status  = '\n ★ تم ترقيته مطور'
...
usertext = '\n ★ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Messi_ElKBer')..')'
status  = '\n ★ تم ترقيته مطور'
...
local ELMMALIK1_Msg = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ELMMALIK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Messi_ElKBer')..') \n ★ '..ELMMALIK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ELMMALIK_Msg and not Special(msg) then  
local ELMMALIK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ELMMALIK_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★ ["..ELMMALIK_Msg.."] \n")
else
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/Messi_ElKBer)}\n ★ ["..ELMMALIK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ★ عذرا » {["..data.first_name_.."](T.ME/Messi_ElKBer)}\n ★ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."ELMMALIK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ELMMALIK:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."ELMMALIK:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."ELMMALIK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ELMMALIK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ELMMALIK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ELMMALIK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ELMMALIK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."ELMMALIK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ELMMALIK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."ELMMALIK:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."ELMMALIK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ELMMALIK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "★ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Messi_ElKBer")..")\n★ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ELMMALIK:teh"..msg.chat_id_).."} بجانب اسمك\n★ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local ELMMALIKChengName = database:get(bot_id.."ELMMALIK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ELMMALIKChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ELMMALIKChengName..']')
database:del(bot_id.."ELMMALIK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ELMMALIKChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."ELMMALIK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ELMMALIKChengUserName = database:get(bot_id.."ELMMALIK:Cheng:UserName"..data.id_)
if not data.username_ then 
if ELMMALIKChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ELMMALIKChengUserName..']')
database:del(bot_id.."ELMMALIK:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ELMMALIKChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ELMMALIK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ELMMALIKChengPhoto = database:get(bot_id.."ELMMALIK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ELMMALIKChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."ELMMALIK:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ELMMALIKChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ELMMALIK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
★W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝒅𝒆𝒔𝒂★
★مرحب بيك في سورس ميسي الاعظم★
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 MESSI 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/Messi_ElKBer"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 MIDO 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/@Medoiuu"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 KORY 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/@Kory_111"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 SOURSCE 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️', url="t.me/Messi_ElKBer"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Messi_ElKBer&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مطور السورس' or text == 'ميدو' or text == 'محمد' then
local Text = [[
...
if text == 'ميسي' or text == 'ميسي' or text == 'ميسي فوء' then
local Text = [[
[DEV KORY](t.me/Kory_111)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 KORY 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/@Kory_111"}},
...
if text == 'ميسي' or text == 'desA' or text == 'dEsa' then
local Text = [[
DEV DESA
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿MESSI 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/@Messi_ElKBer"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Messi_ElKBer&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[ 
[CH](t.me/Messi_ElKBer)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚', url="t.me/Messi_ElKBer"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[TWL](t.me/Messi_ElKBer25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/Messi_ElKBer25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[DEV DESA](t.me/Messi_ElKBer)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲', url="t.me/Messi_ElKBer"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Messi_ElKBer&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب ميسي' then
local Text = [[
𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝚂𝙰
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Messi_ElKBer')..') \n ★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Messi_ElKBer')..') \n ★ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر المبرمج ميسي\n")
return false 
end
...
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر المبرمج ميسي عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1295339524) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك كتم المبرمج ميسي\n")
return false 
end
if result.sender_user_id_ == tonumber(859213488) then
...
if tonumber(result.id_) == tonumber(1295339524) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع كتم المبرمج ميسي عام")
return false 
end
if tonumber(result.id_) == tonumber(859213488) then  
...
if Get_info then
local TextS = "\n ★ اهلا بك في متجر ملفات ميسي\n ★ ملفات السورس ↓\n≪━━━━━━𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲━━━━━━≫\n ★ علامة تعني { ✔️ } ملف مفعل\n ★ علامة تعني { ✖ } ملف معطل\n ★ قناة سورس ميسي ↓\n".." ★ [اضغط هنا لدخول](t.me/Messi_ElKBer) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ★ عذرا الملف لايدعم سورس ميسي \n") 
end
return false
end
...
if text == ("مسح قائمه ميسي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ★ تم مسح قائمه ميسي')
return false
end

if text == 'قائمه ميسي' and Sudo(msg) then
...
if text == ("رفع ميسي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميسي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ميسي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميسي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ميسي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ميسي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميسي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ميسي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميسي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ميسي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SRC-ELMMALIK")
...
function Function_ELMMALIK(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ELMMALIK, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ELMMALIK, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Messi_ElKBer')..')'
status  = '\n ★ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Messi_ElKBer')..')'
...
database:set(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ★ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ELMMALIK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ELMMALIK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ★ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ELMMALIK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ELMMALIK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ELMMALIK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ★ ارسل الكلمه الان")  
database:set(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELMMALIK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ELMMALIK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ELMMALIK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ELMMALIK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELMMALIK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ELMMALIK1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ★ قائمة المنع \n≪━━━━━━𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲━━━━━━≫\n"
for k,v in pairs(list) do  
local ELMMALIK_Msg = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ELMMALIK_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Messi_ElKBer')..')'..'\n ★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميسي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميسي')
local ELMMALIK_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_,'['..ELMMALIK_Msg[math.random(#ELMMALIK_Msg)]..']') 
return false
end
if text == "بوت" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميسي')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ★ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ELMMALIK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ELMMALIK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ELMMALIK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"★ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ELMMALIK:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ELMMALIK:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ELMMALIK:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ELMMALIK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ELMMALIK:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ELMMALIK:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ELMMALIK:List:Rd:Sudo")
end
...
database:set(bot_id.."Messi_ElKBer:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Messi_ElKBer:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Messi_ElKBer:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Messi_ElKBer:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Messi_ElKBer:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Messi_ElKBer:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ميسي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ELMMALIK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"★ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ELMMALIK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ELMMALIK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ELMMALIK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ELMMALIK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"★تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ELMMALIK:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميسي').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Messi_ElKBer')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ELMMALIKdx(msg.chat_id_, msg.id_, ' ★ ايدي المجموعة » ( '..msg.chat_id_..' )\n ★ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ★ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ★ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙴𝚂𝙰', url="t.me/Messi_ElKBer"},
{text = 'مبرمج السورس', url="t.me/Messi_ElKBer"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲━━━━━━≫ٴ\n★ [ 𝑬𝑳𝑴𝑴𝑨𝑳𝑰𝑲 ](t.me/Messi_ElKBer)')
end
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ??𝙴𝚂𝙰', url="t.me/Messi_ElKBer"},
{text = 'مبرمج السورس', url="t.me/Messi_ElKBer"},
},
}
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝑴𝑬𝑺𝑺𝑰', url="t.me/Messi_ElKBer"},
{text = 'مبرمج السورس', url="t.me/Messi_ElKBer"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ميسي')
...
ELMMALIK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ELMMALIK)
...
--------------------------------------------------------------------------------------------------------------
SourceELMMALIK(data.message_,data)
plugin_ELMMALIK(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local ELMMALIKAbot = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELMMALIKAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★ ["..ELMMALIKAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local ELMMALIK1_Msg = database:get(bot_id.."ELMMALIK1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELMMALIK1_Msg then    
send(msg.chat_id_, msg.id_," ★ "..ELMMALIK1_Msg)
